...
class BehatLoggerExtension implements ExtensionInterface {
  ...
  public function configure(ArrayNodeDefinition $builder) {
    $builder->children()->scalarNode("name")->defaultValue("behatlogger");
    $builder->children()->scalarNode("renderer")->defaultValue("csv");
  ...
  public function load(ContainerBuilder $container, array $config) {
    $definition = new Definition("prachi\\BehatLogger\\Formatter\\BehatFormatter");
    ...
    $container->setDefinition("csv.formatter", $definition)
